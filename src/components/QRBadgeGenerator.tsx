...
export const QRBadgeGenerator: React.FC<QRBadgeGeneratorProps> = ({ worker, onClose, standalone = false }) => {
  ...
  const badgeContent = (
    <div 
      ref={badgeRef} 
      className="fotocheck-printable bg-white text-slate-900 rounded-2xl border-4 border-emerald-600 p-4 space-y-3 shadow-md relative overflow-hidden mx-auto w-[360px]"
    >
      {/* Top Header Bar */}
